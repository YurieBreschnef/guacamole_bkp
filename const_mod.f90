module const
  ...
  ! level 0: no output, level 1: short, level 2: extensive
	...
	real(kind = rp) ,parameter 		:: Lx	          = 4.0 !50.0_rp
	real(kind = rp) ,parameter 		:: Ly	          = 4.0 !50.0_rp
  ...
  integer(kind = ip)            :: shearing = 1
	...
	real(kind = rp),parameter			:: B_comp   = 50.0_rp
